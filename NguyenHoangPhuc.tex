...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubhead
        ...
        {Advanced Program in Computer Science;  GPA: 9.57/10.0 -- 3.99/4.00}
        \resumeItemListStart
            \resumeItem{Honors: Dean’s List of the academic year 2022-2023 \textbf{(Top 1 GPA)}.}
            \resumeItem{Review coursework: Linear Algebra, Statistics, Data Structures, Discrete Structures, Logical Structures, Calculus, Computer Systems, Database, Scientific Method, Technical Writing, OOP, General Physics, Computer Hardware, Mobile Application Development.}
        \resumeItemListEnd
    \resumeSubhead
